 ...
 * Product Class
 * <p>
 * product object to for items being sold
 *
...
public class Product implements Serializable {
    ...
    public void editAvailableQuantity(int availableQuantity) {     //directly editing this field should only be
        // allowed to sellers
        this.availableQuantity = availableQuantity;
        saveProduct();
    }
...
//    public static void addToShoppingCart(String productName, ArrayList<String> shoppingCart) {
